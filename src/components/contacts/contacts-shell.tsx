    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="ml-auto inline-flex items-center gap-1.5 rounded-lg bg-brand-500 px-3 py-2 text-sm font-medium text-white hover:bg-brand-600"
        >
                  ...
                  return (
                    <tr key={c.id} className="hover:bg-gray-50/50">
                      <td className="px-4 py-2.5">
                        ...
                        <div className="text-[11px] text-gray-400">{c.phone_e164 || c.phone_canonical}</div>
                      </td>
                      <td className="px-4 py-2.5">
                        {c.category ? (
                          <span
