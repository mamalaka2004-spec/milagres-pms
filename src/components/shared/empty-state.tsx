  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 lg:p-16 text-center">
      ...
      {action && (
        <Link
          href={action.href}
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-brand-500 hover:bg-brand-600 text-white font-semibold text-sm transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400/40"
        >
          {action.label}
        </Link>
      )}
