...
export async function getOrCreateConversation(opts: {
  ...
  if (opts.conversationId) {
    ...
    // Conversations are user-private. Reject any conversation whose user_id
    // doesn't match the caller — including null user_id rows (orphaned/seeded),
    // which would otherwise bypass the user-isolation check.
