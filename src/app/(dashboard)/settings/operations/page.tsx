...
import { OperationsSettingsShell } from "@/components/settings/operations-settings-shell";
    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 rounded-full bg-brand-500 flex items-center justify-center">
          <ClipboardList size={16} className="text-white" aria-hidden="true" />
        </div>
        <div>
          <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Operações &amp; Camareira</h1>
          <p className="text-xs text-gray-500">
            Auto-agendamento de limpeza, checklists por unidade e retenção de mídia
          </p>
        </div>
      </div>
      <OperationsSettingsShell />
    </div>
  );
}
