      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <Link
                ...
                className="font-body text-xs text-brand-500 hover:text-brand-600 transition-colors duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400/40"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-lg bg-brand-500 hover:bg-brand-600 text-white font-body font-semibold text-sm transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400/40 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
